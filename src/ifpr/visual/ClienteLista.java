...
public class ClienteLista extends JFrame {
	...
	public ClienteLista() {
		...
		JLabel lbTitulo = new JLabel("Clientes");
		...
		btNovo.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				ClienteCadastro prod = new ClienteCadastro();
		...
		btNovo.setIcon(new ImageIcon(ClienteLista.class.getResource("/ico/plus-24.png")));
		...
		btnAlterar.setIcon(new ImageIcon(ClienteLista.class.getResource("/ico/edit-2-24.png")));
		btnAlterar.setMnemonic('a');
		tbAcoes.add(btnAlterar);
		
		JButton btnExcluir = new JButton("Excluir");
		btnExcluir.setBackground(Color.WHITE);
		btnExcluir.setIcon(new ImageIcon(ClienteLista.class.getResource("/ico/x-mark-24.png")));
		...
		btFechar.setIcon(new ImageIcon(ClienteLista.class.getResource("/ico/exit-24.png")));
