...
public class ProfissionalLista extends JFrame {
	...
	public ProfissionalLista() {
		...
		JLabel lbTitulo = new JLabel("Profissionais");
		...
		btNovo.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				ProfissionalCadastro prod = new ProfissionalCadastro();
		...
		btNovo.setIcon(new ImageIcon(ProfissionalLista.class.getResource("/ico/plus-24.png")));
		...
		btnAlterar.setIcon(new ImageIcon(ProfissionalLista.class.getResource("/ico/edit-2-24.png")));
		btnAlterar.setMnemonic('a');
		tbAcoes.add(btnAlterar);
		
		JButton btnExcluir = new JButton("Excluir");
		btnExcluir.setBackground(Color.WHITE);
		btnExcluir.setIcon(new ImageIcon(ProfissionalLista.class.getResource("/ico/x-mark-24.png")));
		...
		btFechar.setIcon(new ImageIcon(ProfissionalLista.class.getResource("/ico/exit-24.png")));
